...
<div class="row">
	<div class="col-sms-12">
		...
		<div>
			<a href="{{ url('/admin/products/create')}}" class="btn btn-success btn-sm" title="Add New Page"><i class="fa fa-plus" arira-hidden="true"></i>Add New Product</a>
				...
				<table class="table table-borderless">
					...
					@foreach($products as $item)
						<tr>
							...
							<td><a href="{{ url('/admin/products/' . $item->id . '/edit')}}" title="Edit Page"><button class="btn btn-info-sm">Edit</button></a>
								{!! Form::open([
									'method' => 'DELETE',
